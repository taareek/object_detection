...
class YOLOV1(nn.Module):
    """
    The model has three main componenets:
    1. Backbone -> resnet34 pretrained on 224x224 images from ImageNet
    2. YOLO detection head -> 4 Conv, BatchNorm, LeakyReLU Layers
    ...
    def __init__(self, im_size, num_classes, model_config):
        ...
        # getting backbone model for feature extraction 
        ...
        ###########################
        # Detection Conv. Layers -> yolo head
        ###########################
